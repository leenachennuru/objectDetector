...
def Experiment():
    ...
    baseDirectory = "/export/pablo/"        
    
    experimentName = "SFEW_Basic_test"    
    repetitions = 1    
    ...
    layer0 = [5,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, True]        
    layer1 = [5,(10,10), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, True]        
    layer3 = [5,(5,5), True, (2,2), inhibitoryField0 , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, True]        
    ...
    """
    directoryDataStructure0 = ["Datasets/SFEW/training_faces", 60, 20, 20] 
    ...
    inputStructure0 = [1, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0, (64,64), True, DataUtil.COLOR_SPACE["Whiten"], 1]        
    
    
    channel0 = (inputStructure0, [layer0, layer1, layer3], True)            
...
#    crossConvChannel2 = [ [(0,0), (1,0)], [layer3]]
    ...
    hiddenLayer1 = [500, DataUtil.ACTIVATION_FUNCTION["ReLU"], True, True, False, True, DataUtil.HIDDEN_LAYER_TYPE["Common"]]
    hiddenLayer2 = [500, DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, False, True, DataUtil.HIDDEN_LAYER_TYPE["Common"]]
