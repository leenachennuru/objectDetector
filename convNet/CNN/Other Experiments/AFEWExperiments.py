...
def Experiment():
    ...
    experimentName = "TrainData_NoCrossChannel_4_Frames_Vision"    
    repetitions = 1    
    ...
    """
    #directoryDataStructure0 = ["Train_Faces_Only_4_Frames", 50, 10, 40] 
    #directoryDataStructure1 = ["Train_Audio_Sychronized_4_Frames", 50, 10, 40] 
    
    #directoryDataStructure0 = ["Validation/Validation_Faces_Only_4_Frames", 50, 10, 40] 
    #directoryDataStructure1 = ["Validation/Validation_Audio_Sychronized_4_Frames", 50, 10, 40] 
    
    directoryDataStructure0 = ["Validation/Validation_Faces_Only_4_Frames", "Validation/Validation_Faces_Only_4_Frames", "Train_Faces_Only_4_Frames"]
    directoryDataStructure1 = ["Validation/Validation_Faces_Only_4_Frames", "Validation/Validation_Faces_Only_4_Frames", "Train_Faces_Only_4_Frames"]
    
    
    #directoryDataStructure0 = ["Train_Faces_Only_4_Frames", "Validation/Validation_Faces_Only_4_Frames", "Validation/Validation_Faces_Only_4_Frames"]
    #directoryDataStructure1 = ["Train_Audio_Sychronized_4_Frames", "Validation/Validation_Audio_Sychronized_4_Frames", "Validation/Validation_Audio_Sychronized_4_Frames"]
...
#    crossConvChannel2 = [ [(0,0), (1,0)], [layer3]]
    ...
    hiddenLayer1 = [500, DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, False, True, DataUtil.HIDDEN_LAYER_TYPE["Common"]]
