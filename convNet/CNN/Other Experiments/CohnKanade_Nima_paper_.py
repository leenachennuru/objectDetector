...
def Experiment():
    ...
    inputStructure0 = [4, DataUtil.DATA_MODALITY["Face"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0, (60,60), False, DataUtil.COLOR_SPACE["Whiten"], 0]        
...
#    crossConvChannel2 = [ [(0,0), (1,0)], [layer3]]
    ...
    hiddenLayer1 = [100, DataUtil.ACTIVATION_FUNCTION["Tanh"], False, True, False, True, DataUtil.HIDDEN_LAYER_TYPE["Common"]]
