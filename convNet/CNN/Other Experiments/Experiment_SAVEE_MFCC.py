...
def Experiment():
    ...
    baseDirectory = "/data/datasets/SAVEE/"        
    
    experimentName = "Experiment_SAVEEE_All_02"    
    repetitions = 1    
...
#    layer2 = [10,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, True]        
    ...
    directoryDataStructure0 = ["AudioPerSubject/separated/DC_JE/train/", "AudioPerSubject/separated/DC_JE/validation/","AudioPerSubject/separated/DC_JE/test/"]
    ...
    inputStructure0 = [1, DataUtil.DATA_MODALITY["Audio"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0, (35,26), False, DataUtil.FEATURE_TYPE["GrayScale"], 1]        
