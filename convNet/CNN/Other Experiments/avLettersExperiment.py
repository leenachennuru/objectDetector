...
def Experiment():
    ...
    baseDirectory = "/informatik2/wtm/home/barros/Documents/Experiments/avLetters/"        
    
    experimentName = "GrayAudio"    
    repetitions = 1     
    ...
    layer0 = [5,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], True, False, True]        
    layer1 = [5,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["SobelX"], DataUtil.ACTIVATION_FUNCTION["Tanh"], True, False, False]        
    layer2 = [5,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["SobelY"], DataUtil.ACTIVATION_FUNCTION["Tanh"], True, False, False]        
    
    
    layer3 = [20,(7,7), True, (2,2), inhibitoryField0, DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], True, False, True]                     
    ...
    inputStructure0 = [1, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Static"], "audio_GrayScale", (40,26), False, DataUtil.COLOR_SPACE["GrayScale"], 0]    
    inputStructure1 = [4, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Sequence"], "images_sequence_4", (40,26), False, DataUtil.COLOR_SPACE["GrayScale"], 0]    
  
    
    channel0 = (inputStructure0, [layer0, layer3], True)                      
    channel1 = (inputStructure0, [layer1, layer3], True)                      
    channel2 = (inputStructure0, [layer2, layer3], True)    
...
#    crossConvChannel2 = [ [(0,0), (1,0)], [layer3]]
    ...
    hiddenLayer1 = [100, DataUtil.ACTIVATION_FUNCTION["Tanh"], True, False, False, True]    
