...
def Experiment1Channel(feature, turn, dataset):
                
    #Experiment parameters
    baseDirectory = "/data/datasets/AFEW/"        
    
    experimentName = "IJCNN_FinalExperiments_PreTrained_"+dataset+"_"+str(feature)+"_Turn_"+str(turn)     
    repetitions = 1    
    ...
    #None
    preloadedFilters = None #DataUtil.loadNetworkState("/data/datasets/SAVEE/experimental_Results_IJCNN_2016/Speaker_Dependent/MAG/JE/FinalExperiments_JE_MAG_Turn_3/model/repetition_2_BestValidation_FinalExperiments_JE_MAG_Turn_3_.save")[4]
        # "/data/datasets/GTZAN/experiments/IJCNN_FinalExperiments_GTZAN_MAG_Turn_0/model/repetition_2_FINAL_IJCNN_FinalExperiments_GTZAN_MAG_Turn_0_.save"
...
#    layer2 = [10,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, True]        
    ...
    #layerEx53p = [10,(1,3), True, (1,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, True]        
    #layerEx532p = [20,(1,3), True, (1,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, True]        
    ...
    layer0t = [1,(1,11), True, (1,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, True]            
    layer0s = [1,(11,1), True, (2,1), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, True]            
    layer0b = [10,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, False]            
    layer1b = [20,(3,3), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, False]            
    
    layerEx53 = [5,(1,3), True, (1,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, False]        
    layerEx53p = [10,(1,3), True, (1,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, False]        
    layerEx532p = [20,(1,3), True, (1,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, False]  
    ...
    """     
    #directoryDataStructure0 = ["AudioAll/training", 5] 
    #directoryDataStructure0 = ["DC_JE/MAG_SPEC_2048/train/", "DC_JE/MAG_SPEC_2048/validation/","DC_JE/MAG_SPEC_2048/test/"]
    #directoryDataStructure0 = ["ALL/MAG_2048_1/training/", 4]
   
    #directoryDataStructure0a = ["DC_JE/POW_SPEC_2048_1/train/", "DC_JE/POW_SPEC_2048_1/validation/","DC_JE/POW_SPEC_2048_1/test/"]
    #directoryDataStructure0a = ["DC_JE/MFCC_2048_1/train/", "DC_JE/MFCC_2048_1/validation/","DC_JE/MFCC_2048_1/test/"]
    #directoryDataStructure0a = ["ALL/MFCC_2048_1/training/", 4]
    #directoryDataStructure0b = ["ALL/POW_2048_1/training", 4]
    


    #directoryDataStructure0 = ["MAG_SPEC_2048_1/DC", 4]
    #directoryDataStructure0a = ["POW_SPEC_2048_1/DC", 4]
    ...
    #directoryDataStructure0 = [("AudioPerSubject/separated/DC/train"), ("AudioPerSubject/separated/DC/validation"),("AudioPerSubject/separated/DC/test")]
    #directoryDataStructure0 = [("ALL/POW_DC_2048_1/train"), ("ALL/POW_DC_2048_1/validation"),("ALL/POW_DC_2048_1/test")]
   
    #directoryDataStructure0 = [("POW_SPEC_2048_1/DC"), 4]
#    directoryDataStructure0 = [("AudioPerSubject/not_separated/"+dataset+"/"), 4]
    directoryDataStructure0 = [("Train_Audio/"), ("Validation_Audio/"), ("Validation_Audio/")]
    #directoryDataStructure0 = [("audio_wav/training/"), 4]
    #directoryDataStructure0 = [("AudioPerSubject/not_separated/DC"), 4]
    
    #directoryDataStructure0 = [("ALL/POW_TEST_2048_1/DC"), 4]
    #directoryDataStructure0 = [("POW_SPEC_2048_1/DC"), 4]
    #directoryDataStructure0 = [("AudioPerSubject/separated/DC/train"), ("AudioPerSubject/separated/DC/validation"), ("AudioPerSubject/separated/DC/test")]
    ...
    """ Input Structure
        (int,DATA_MODALITY, IMAGE_STRUCTURE, String, (int,int)) inputStructure - Defines what is the structure of the input. It is possible to use different modalities of input,
                      ...
                      int - inputImages / Slices (in seconds) of an audio input
    ...
    inputStructure0 = [1, DataUtil.DATA_MODALITY["Audio"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0, (17,128), False, DataUtil.FEATURE_TYPE[str(feature)], 1]        
            
    #inputStructure0a = [1, DataUtil.DATA_MODALITY["Audio"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0, (17,128), False, DataUtil.FEATURE_TYPE["MAG"], 1]        
    
    inputStructure0a = [1, DataUtil.DATA_MODALITY["Audio"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0, (35,26), False, DataUtil.FEATURE_TYPE["MFCC"], 1]        
 #   inputStructure0b = [1, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0b, (17,128), False, DataUtil.FEATURE_TYPE["GrayScale"], 1]        
    
    #inputStructure0a = [1, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0a, (35,13), False, DataUtil.FEATURE_TYPE["GrayScale"], 1]        
    #inputStructure0b = [1, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0b, (41,13), False, DataUtil.FEATURE_TYPE["GrayScale"], 1]        
    #inputStructure1 = [1, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure1, (151,13), False, DataUtil.FEATURE_TYPE["GrayScale"], 1]        
    #inputStructure2 = [1, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure2, (151,13), False, DataUtil.FEATURE_TYPE["GrayScale"], 1]        
    
    
    
    channel0 = (inputStructure0, [layer0b, layer1b], True)             
    #channel0a = (inputStructure0a, [layer0b, layer1b], True)  
    
    channel0a = (inputStructure0a, [layerEx53, layerEx53p, layerEx532p], True)        
#    channel0b = (inputStructure0b, [layer0b, layer1b], True)             
...
#    crossConvChannel2 = [ [(0,0), (1,0)], [layer3]]
    ...
    hiddenLayer1 = [500, DataUtil.ACTIVATION_FUNCTION["Tanh"], False, True, False, True, DataUtil.HIDDEN_LAYER_TYPE["Common"]]
...
def Experiment2Channels(feature, turn, dataset):
                
    #Experiment parameters
    baseDirectory = "/data/datasets/AFEW/"        
    
    experimentName = "IJCNN_FinalExperiments_"+dataset+"_"+str(feature)+"_MFCC_Turn_"+str(turn)     
    repetitions = 5    
    isGeneratingMetrics = True
    isGeneratingSynchronizedMetrics = True
    ...
    #None
    preloadedFilters = None #DataUtil.loadNetworkState("/data/datasets/SAVEE//experiments/Experiment_SAVEEE_POW_3Channels_MAG_MFCC_POW_ALL//model//repetition_0_BestTest_Experiment_SAVEEE_POW_3Channels_MAG_MFCC_POW_ALL_.save")[4]
...
#    layer2 = [10,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, True]        
    ...
    layer0t = [1,(1,11), True, (1,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, True]            
    layer0s = [1,(11,1), True, (2,1), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, True]            
    layer0b = [10,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, True]            
    layer1b = [20,(3,3), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, True]            
    ...
    #directoryDataStructure0 = [("POW_SPEC_2048_1/DC"), 4]
    #directoryDataStructure0 = [("AudioPerSubject/not_separated/"+dataset+"/"), 4]
    #directoryDataStructure0 = [("AudioPerSubject/not_separated/Speaker_Independent/"+dataset+"_ALL/ALL/"), ("AudioPerSubject/not_separated/Speaker_Independent/"+dataset+"_ALL/"+dataset), ("AudioPerSubject/not_separated/Speaker_Independent/"+dataset+"_ALL/"+dataset)]
    #directoryDataStructure0 = [("audio_wav/training/"), 4]    
    directoryDataStructure0 = [("Train_Audio/"), ("Validation_Audio/"), ("Validation_Audio/")]
    #directoryDataStructure0 = [("AudioPerSubject/not_separated/DC"), 4]
...
def ExperimentPOWMAG(turn, dataset):
                
    #Experiment parameters
    baseDirectory = "/data/datasets/GTZAN//"        
    
    experimentName = "IJCNN_FinalExperiments_"+dataset+"_POW_MAG_Turn_"+str(turn)     
    repetitions = 5    
    isGeneratingMetrics = True
    isGeneratingSynchronizedMetrics = True
...
#    layer2 = [10,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, True]        
    ...
    inputStructure0 = [1, DataUtil.DATA_MODALITY["Audio"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0, (17,128), False, DataUtil.FEATURE_TYPE["POW"], 1]        
...
def ExperimentMFCC(turn, dataset):
                
    #Experiment parameters
    baseDirectory = "/data/datasets/AFEW/"        
    
    experimentName = "IJCNN_FinalExperiments_"+dataset+"_MFCC_Turn_"+str(turn)     
    repetitions = 5    
    isGeneratingMetrics = True
    isGeneratingSynchronizedMetrics = True
...
#    layer2 = [10,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], False, False, True]        
    ...
    inputStructure0b = [1, DataUtil.DATA_MODALITY["Audio"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0, (35,26), False, DataUtil.FEATURE_TYPE["MFCC"], 1]        
 #   inputStructure0b = [1, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0b, (17,128), False, DataUtil.FEATURE_TYPE["GrayScale"], 1]        
    ...
    channel0b = (inputStructure0b, [layerEx53, layerEx53p, layerEx532p], True)        
#    channel0b = (inputStructure0b, [layer0b, layer1b], True)             
...
def Experiment3Channels(turn, dataset):
                
    #Experiment parameters
    baseDirectory = "/data/datasets/AFEW/"        
    
    experimentName = "IJCNN_FinalExperiments_"+dataset+"_MFCC_POW_MAG_Turn_"+str(turn)     
    repetitions = 5    
    isGeneratingMetrics = True
    isGeneratingSynchronizedMetrics = True
...
Experiment1Channel("MFCC", 0, "AFEW_AUDIO")


    
#for dataset in {"AFEW_AUDIO"}:
#    for i in range(1):
#        for f in {"MAG", "POW"}:                    
#            Experiment1Channel(f, i, dataset)
#            Experiment2Channels(f, i, dataset)
#        #ExperimentPOWMAG(i,dataset)
#        ExperimentMFCC(i, dataset)
#        Experiment3Channels(i, dataset)