...
def Experiment():
    ...
    baseDirectory = "/export/experiments/cohn-kanade/"        
    
    experimentName = "TestBasic"    
    repetitions = 1     
    ...
    layer0 = [5,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, True, True]        
    layer1 = [10,(5,5), True, (4,4), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, True, True]        
    ...
    """
    #directoryDataStructure0 = ["sequences_DEMO", 50, 25, 25] 
    ...
    inputStructure0 = [4, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0, (42,42), False, DataUtil.COLOR_SPACE["Whiten"], 2]        
...
#    crossConvChannel2 = [ [(0,0), (1,0)], [layer3]]
    ...
    hiddenLayer1 = [200, DataUtil.ACTIVATION_FUNCTION["Tanh"], True, True, True, True, DataUtil.HIDDEN_LAYER_TYPE["Common"]]
    hiddenLayer2 = [110, DataUtil.ACTIVATION_FUNCTION["Tanh"], True, True, True, True, DataUtil.HIDDEN_LAYER_TYPE["Common"]]
