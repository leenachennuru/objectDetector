...
def Experiment():
    ...
    experimentName = "Experiments_4_Frames_10FoldCrossValidation"    
    repetitions = 10    
    ...
    """ 
    directoryDataStructure0 = ["CKFaces_Frames_4/", 10] 
    ...
    inputStructure0 = [4, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Sequence"], directoryDataStructure0, (28,28), False, DataUtil.FEATURE_TYPE["GrayScale"], 1]        
