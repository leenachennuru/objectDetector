...
def Experiment():
    ...
    baseDirectory = "/data/datasets/FABO/"        
    
    experimentName = "FABO_M10_3_Frames"    
    repetitions = 10    
    ...
    """ 
    directoryDataStructure0 = ["FABO_M10_3_Frames/", 10] 
    ...
    inputStructure0 = [3, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Sequence"], directoryDataStructure0, (25,19), False, DataUtil.FEATURE_TYPE["GrayScale"], 1]        
