...
def Experiment():
    ...
    layer0 = [5,(3,3), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, True]

    layer1 = [5,(3,3), False, (2,2), None, DataUtil.LAYER_TYPE["SobelX"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, False]
    layer2 = [5,(3,3), False, (2,2), None, DataUtil.LAYER_TYPE["SobelY"], DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, False]

    layer3 = [5,(3,3), True, (4,4), None, DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["Tanh"], True, False, True]
    ...
    inputStructure0 = [4, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Sequence"], "sequences_DEMO", (50,50), False, DataUtil.COLOR_SPACE["RGB"], 0]
    #inputStructure1 = [3, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Static"], "images", (50,50), False, DataUtil.COLOR_SPACE["GrayScale"], 0]
    ...
    channel1 = (inputStructure0, [layer1,layer0,  layer3 ], True)
    channel2 = (inputStructure0, [layer2,layer0,  layer3 ], True)
...
#    channels.append(channel2)
    ...
    hiddenLayer1 = [50, DataUtil.ACTIVATION_FUNCTION["ReLU"], False, True, False, True]
