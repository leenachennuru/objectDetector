...
def Experiment():
    ...
    baseDirectory = "/informatik2/students/home/4wahab/Desktop/convNetDataset/"        
    
    experimentName = "convNetContoursResized20Epoch"    
    repetitions = 1    
    ...
    layer0 = [5,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], False, False, True]        
    layer1 = [10,(5,5), True, (2,2), None , DataUtil.LAYER_TYPE["Common"], DataUtil.ACTIVATION_FUNCTION["ReLU"], False, False, True]        
    ...
    """
    #directoryDataStructure0 = ["motion_full", 60, 20, 20] 
    directoryDataStructure0 = [("convNetFullNormalizedDemo/training"), ("convNetFullNormalizedDemo/validation"),("convNetFullNormalizedDemo/testing")]
    ...
    inputStructure0 = [1, DataUtil.DATA_MODALITY["Image"], DataUtil.IMAGE_STRUCTURE["Static"], directoryDataStructure0, (100,100), False, DataUtil.FEATURE_TYPE["GrayScale"], 1]        
...
#    crossConvChannel2 = [ [(0,0), (1,0)], [layer3]]
    ...
    hiddenLayer1 = [1000, DataUtil.ACTIVATION_FUNCTION["ReLU"], True, False, False, True, DataUtil.HIDDEN_LAYER_TYPE["Common"]]
